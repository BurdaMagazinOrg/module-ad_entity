...
class AdTechType extends AdTypeBase {
  ...
  public function globalSettingsForm(array $form, FormStateInterface $form_state, Config $config) {
    ...
    $element['page_targeting'] = [
      ...
      '#description' => $this->stringTranslation->translate("Default pairs of key-values for targeting on the page. Example: <strong>pos: 'top', category: ['value1', 'value2']</strong>, ..."),
  ...
  public function entityConfigForm(array $form, FormStateInterface $form_state, AdEntityInterface $ad_entity) {
    ...
    $element['targeting'] = [
      ...
      '#description' => $this->stringTranslation->translate("Default pairs of key-values for targeting on the ad tag. Example: <strong>pos: 'top', category: ['value1', 'value2']</strong>, ..."),
